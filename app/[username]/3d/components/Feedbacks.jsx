...
const ImageCarousel = ({currentUser}) => {
  ...
  return (
    <div className="carousel-container">
      ...
      <div>
        <img
          src={`https://github-readme-stats.vercel.app/api?username=${gitusername}&show_icons=true&theme=tokyonight`}
          alt="GitHub Stats"
  ...
  return (
    <>
      ...
      <div className={` bg-black-100 rounded-[20px]`}>
        <div
          className={`bg-tertiary rounded-2xl md:px-16 py-5 md:py-10 min-h-[300px]`}
        >
        ...
        <div className={`-mt-20 pb-14 ${styles.paddingX} flex flex-wrap gap-7`}>
          ...
          <ImageCarousel currentUser={currentUser} />
        </div>
      </div>
    </>
  );
